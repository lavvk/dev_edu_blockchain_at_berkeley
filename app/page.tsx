...
export default function HomePage() {
  ...
  const topVideos: Video[] = [
    ...
    {
      url: "https://www.instagram.com/reel/C8lFmJpMOKM/?igsh=NTc4MTIwNjQ2YQ==",
      title: "wax rainbow slime",
      description: "i also like this wax cracking +1 point for adding more wax at the end",
      rating: 9.5,
    },
    {
      url: "https://www.instagram.com/reel/DT0FcKTAdFk/?igsh=NTc4MTIwNjQ2YQ==",
      title: "white fluffy slime",
      description: "ok at first it was lowkey mid bc the finger pressings werent that satisfying but then they like cracked the bubbles and the slime is rlyyy stretchy and that rly scratched my brain right so +1.5 points for that",
      rating: 9.2,
    },
    {
      url: "https://www.instagram.com/reel/DABtlkXIE5S/?igsh=NTc4MTIwNjQ2YQ==",
      title: "orange fluffy slime",
      description: "really satisfying i want this slime so bad",
      rating: 9.4,
    },
    {
      url: "https://www.instagram.com/reel/DVDvTYOEjfD/?igsh=NTc4MTIwNjQ2YQ==",
      title: "green fluffy slime",
      description: "ok idt the hand pressing was as satisfying as orange but the bubbles were good and i like the color",
      rating: 8.8,
    },
  ];
